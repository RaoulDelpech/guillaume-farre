...
export const metadata: Metadata = {
  title: "Atelier",
  description: "L'atelier de Guillaume Farré : quatre Ferrari Dino, 1200 kilos d'instruments de création. Découvrez l'espace où naissent les œuvres, entre mécanique et peinture.",
  openGraph: {

          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-muted-foreground font-light leading-relaxed">
                <EditableText
                  textKey="dinoHistoire.alfredo.p1"
                  as="p"
                  multiline
                >
                ...
                <EditableText
                  textKey="dinoHistoire.alfredo.p2"
                  as="p"
                  multiline
                >
                ...
                <EditableText
                  textKey="dinoHistoire.alfredo.p3"
                  as="p"
                  multiline
                >
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 bg-primary/10 p-6 rounded-lg border border-primary/20">
                <EditableText
                  ...
                  as="p"
                  className="text-sm font-light text-foreground italic"
                >
      ...
      <section className="py-24 md:py-32 bg-muted/30 border-b border-border">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <EditableText
              textKey="dinoHistoire.moteur.subtitle"
              as="p"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-background p-8 rounded-lg border border-border">
              ...
              <EditableText
                textKey="dinoHistoire.moteur.f2"
                as="p"
            ...
            <div className="bg-background p-8 rounded-lg border border-border">
              ...
              <EditableText
                textKey="dinoHistoire.moteur.f1"
                as="p"
                className="text-muted-foreground font-light"
              >
            ...
            <div className="bg-background p-8 rounded-lg border border-border">
              ...
              <EditableText
                textKey="dinoHistoire.moteur.route"
                as="p"
                className="text-muted-foreground font-light"
              >
                La Dino 206 GT est présentée. Pour la première fois, le V6 Dino équipe une voiture de route, accessible au grand public.
              </EditableText>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8 text-lg text-muted-foreground font-light leading-relaxed">
              <EditableText
                textKey="dinoHistoire.heritage.p1"
                as="p"
                multiline
              >
              ...
              <EditableText
                textKey="dinoHistoire.heritage.p2"
                as="p"
                multiline
              >
              ...
              <EditableText
                textKey="dinoHistoire.heritage.p3"
                as="p"
                multiline
              >
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <div className="space-y-6 text-lg text-muted-foreground font-light leading-relaxed">
                <EditableText
                  textKey="dinoHistoire.maDino.p1"
                  as="p"
                  multiline
                >
